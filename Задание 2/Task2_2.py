...
def Verlet_CL(num_elem, Time, pos_x, pos_y, v_x, v_y, a, mas):
    start_time = time.time()
...
def main():
    ...
    for c_i in range(len(count)):
        ...
        for i in range(repeat):
            ...
            time_Verl_proc[c_i] += Verlet_proc_pool(num_elem, Time, pos_x, pos_y, v_x, v_y, a, mas)
        ...
        for i in range(repeat):
            time_Verl_CL[c_i] += Verlet_CL(num_elem, Time, pos_x, pos_y, v_x, v_y, a, mas)
