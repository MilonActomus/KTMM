...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def Parsing(self, Mname, Pname, Tname, time, Tmax, Tmin, Time_):
        self.count = 5
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def Start(self):
        self.glWidget.Parsing(self.Mname.text(), self.Pname.text(), self.Tname.text(), int(self.Time_param.text()), int(self.Tmax.text()), int(self.Tmin.text()), self.Time_)
