...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def initializeGL(self):
        ...
        self.Parts = []
        self.T = []
        self.t = np.linspace(0, int(self.parent.Time_param.text()), 100)
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def initGUI(self):
        ...
        self.slider.valueChanged.connect(lambda val: self.updateModel(val))
    ...
    def updateModel(self, t_i):
        self.slider.setRange(0, len(self.glWidget.t) - 1)
        self.Time_.setText(str(self.glWidget.t[t_i]))
